                    ...
                    <nav>
                        <ul>
                            ...
                            <li><a href="#"><img src="../imagen/iconos/nuevo.png"> | Ventas</a>
                                <ul>
                                    <li><a href="index.php">&checkmark; Venta</a></li>
...
//Guardo nuevamente el carrito de la session
                                ...
                                <fieldset class="adminform">
                                    ...
                                    <table width="100%" border="0" class="admintable">
                                        ...
                                        <tr>
                                            ...
                                            <td align="20%"><input name="txtCodigo" type="text"  disabled value="<?php echo $cod ?>" size="17">
                                                <input type="submit" name="Buscar_codigo"  value="" title="Buscar">&nbsp;&nbsp;&nbsp;
                                                <a href="#myprod" rel="leanModal" name="signup" class="button_p" title="Buscar producto" style="paddin-top:10px">
                                        ...
                                        <td>
                                            <div class="box_1">
                                                <table width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <input name="textfield4" type="text" id="textfield4" value="<?php echo $num_venta ?>" size="28" style="text-align:center">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="box_1">
                                                <table width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        <td colspan="2"><input type="hidden" name="txtIdCliente" value="<?php echo $idcliente ?>">
                                                            <input name="txtNomClie" type="text" id="txtCliente2" size="35" value="<?php echo $nomcliente ?>">&nbsp;&nbsp;&nbsp;
                                                            <a href="#myclie" rel="leanModal" name="signup" class="button_p" title="Buscar cliente"><img src="../img/icon/buscar_detalle.png"></a>
                                                        </td>
                                                    </tr>
                                                    <tr><td>&nbsp;</td></tr>
                                                    <tr>
                                                        <td>Comprobante: <select name="idtipodocumento">
                                                        ...
                                                        <td>Num. Documento: 
                                                            <input type="text" class="key" disabled name="" required id="fecha">
                                                        </td>
                                                    </tr>
                                                    <tr><td>&nbsp;</td></tr>
                                                    <tr>

                                                        <td align="left">Forma de Pago:
                                                        ...
                                                        <td align="left">Fecha:
                                                            <input type="date" name="" required id="fecha">
                        ...
                        <div id="myclie">
                            ...
                            <div class="modal-body">
                                <div class="box_1">
                                    <table>
                                        <form name="form_cliente_Natural" action="#" method="post" enctype="multipart/form-data" id="form_cliente">
                                            Nombres:<input type="text" name="txtNombre_Cliente" id="txtDato_cliente" size="13">
                                            Pater:<input type="text" name="txtNombre_Cliente" id="txtDato_cliente" size="10">
                                            Mater:<input type="text" name="txtNombre_Cliente" id="txtDato_cliente" size="10">
                                            DNI:<input type="text" name="txtRUC" id="txtDato_cliente" size="8">
                                            &nbsp;<input type="button" name="button" id="button" onClick="enviarParametrosCliente()" value="Ingresar">
                                        </form>
                                ...
                                <div class="box_1">
                                    <table>
                                        <form name="form_cliente_Juridica" action="#" method="post" enctype="multipart/form-data" id="form_cliente">
                                            Razon Social:<input type="text" name="txtNombre_Cliente" id="txtDato_cliente">
                                            RUC:<input type="text" name="txtRUC" id="txtDato_cliente">
                                            &nbsp;<input type="button" name="button" id="button" onClick="enviarParametrosCliente()" value="Ingresar">
                                        </form>
