    ...
    <head>
        ...
        <script>
            function enviarPDF()
            {
                ...
                window.open("reporte_cliente_natural.php?criterio=" + criterio + "&busqueda=" + busqueda, 'win2', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
                return false;
            ...
            function enviarPrinter()
            {
                var criterio = document.datos.criterio.value;
                var busqueda = document.datos.busqueda.value;
                window.open("imprimir_cliente_natural.php?criterio=" + criterio + "&busqueda=" + busqueda, 'win2', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
                return false;
            }
        </script>
    </head>
                ...
                <div class="wrapper">
                    <div class="block">
                        ...
                        <div class="block_head"> 
                            ...
                            <div class="titulo_head">Gestor de Clientes Natural</div>
...
//Parametro del Paginador
                            ...
                            ?>
                            <form name="datos" action="index_natural.php" method="post">
                            ...
                            <table class="adminlist" cellspacing="1">
                                ...
                                <tbody class="adminlist">
                                    ...
                                    while ($row = mysql_fetch_array($result)) {
                                        ...
                                        echo "<td width='5%' align='center'><a href=detalle_cliente_natural.php?idcliente=" . $row["IdCliente"] . " title='Ver Detalle'><img src='../img/Iconfinder/search-16.png' ></td>";
                                        echo "<td width='5%' align='center'><a href=editar_cliente_natural.php?idcliente=" . $row["IdCliente"] . " title='Editar'><img src='../img/Iconfinder/page_edit.png'></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                </tbody>
