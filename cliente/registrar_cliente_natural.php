    ...
    <body>
        ...
        <div class="contenedor">
            ...
            if (isset($_SESSION["usuario"])) {
                ...
                <div class="wrapper">
                    <form action="guardar_cliente_natural.php" method="post" name="form_cliente">
                        <div class="block">
                            <div class="block_head"> 
                                <div class="imagen_head"><img src="../img/Iconfinder/customer.png" width="48" height="45"></div>
                                <div class="titulo_head">REGISTRAR CLIENTE NATURAL</div>
                            ...
                            <div class="block_content">
                                ...
                                <fieldset class="adminform">
                                    <legend>Detalle del cliente Natural</legend>
